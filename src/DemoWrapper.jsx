...
import {
  ...
  PartyPopper, Bell, LayoutDashboard, Shield, Award,
  ChevronRight, Sparkles, Layers, Star
} from "lucide-react";
import App from "./App.jsx";
import { DEMO_CONFIG } from "./demo.config.js";

const iconMap = { CalendarDays, TrendingUp, Heart, Users, CreditCard, PartyPopper, Bell, LayoutDashboard, Shield, Award, Sparkles, Layers, Star };
...
export default function DemoWrapper() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "#f5f5f5", fontFamily: "'DM Sans', system-ui, sans-serif", color: "#1a1a1a" }}>
      ...
      {/* --- LEFT SIDEBAR --- */}
      <aside className="demo-sidebar-left" style={{ width: 320, flexShrink: 0, background: "#fff", borderRight: "1px solid #e5e7eb", display: "flex", flexDirection: "column", position: "fixed", top: 0, left: 0, bottom: 0, zIndex: 10, overflowY: "auto", scrollbarWidth: "none", msOverflowStyle: "none" }}>
        ...
        <div style={{ padding: "20px 24px 16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 44, height: 44, borderRadius: 12, background: accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: DF, fontSize: 22, fontWeight: 700, color: "#fff" }}>
              {c.studio.logo}
            </div>
            <div>
      ...
      {/* --- RIGHT SIDEBAR --- */}
      <aside className="demo-sidebar-right" style={{ width: 340, flexShrink: 0, background: "#fff", borderLeft: "1px solid #e5e7eb", position: "fixed", top: 0, right: 0, bottom: 0, overflowY: "auto", padding: "24px 20px", scrollbarWidth: "none", msOverflowStyle: "none" }}>
